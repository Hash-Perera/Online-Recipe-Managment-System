...
<!---------Methana idn code krnna ganna oyalage ewaa-------------->
    <section class="dashboard">
        ...
        <div class="r-side" id="r-side">

            <h1>Welcome Admin !</h1>

                <div class="r-sideboxes">
                    <div class="chefbtn">
                        <a href="../../IT21206696-Jayasiri k.b.s.r/html/addpromoform.html">Add Promo</a>
                        <a href="delete.php">Delete Promo</a>
                        <a href="update.php">Update Promo</a>
                    </div>

                        <div class="div">

                            <a href="../../IT21205774-herath h.m.y.m/html/Nutrients.html">
                            <div class="boxes">
                                <h2>Add Nutrients</h2>
                            </div>
                            </a>
